...
```
docker run --name havenAgent -d -e "dm_agent_notifier_server=http://MASTER_IP:8761"  --restart=unless-stopped -p 8771:8771 -v /run/docker.sock:/run/docker.sock codeabovelab/agent:latest
```
